 ...
 */
final class Version20200315081110 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_51C88FAD12469DE2 ON prestation (category_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_51C88FAD12469DE2 ON prestation');
